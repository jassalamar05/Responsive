...
export default function Home(){
    ...
    return(
        ...
        {/* text area */}
        <main>
            <div className="flex items-center justify-center mt-10 md:justify-center lg:justify-center  ">
        ...
        <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 p-10 mt-20 gap-2 transition-transform lg:px-60 px-20 sm:px-20 ">
